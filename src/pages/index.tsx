...
// Data in format {title,date,desc,img}
const dummyNewsData = [
    {
        title: "Gunn Bat Cave Destroyed",
        date: new Date("Feburary 15, 2023"),
        description: "The Bat cave was destroyed! Oh no! That's so sad I'm gonna cry",
        imageURL: "",
    },
    {
        title: "Dylan is actually really cool",
        date: new Date("Feburary 15, 2023"),
        description: "Could this actaully be possible? Despite popular opinion, Dylan is ACTUALLY realy cool.",
        imageURL: "",
    },
];
